...
function searchInit() {
    ...
    $.ajax({
        url: '/srh/public/coursescategoria/table', 
        type: 'POST',
        data: {
        ...
        success: function (response) {
            ...
            if (response.value && response.value.length > 0) {
                response.value.forEach(function (object) {
                    const finalUrl = `/srh/public/coursescategoria/edit/${object.id_categoria}`;
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton1">
                                       ...
                                       <!-- Aquí se agrega la opción para eliminar -->
                                        <a class="dropdown-item" href="#" onclick="confirmDelete(${object.id_categoria})">
...
function deleteCourse(id) {
    $.ajax({
        url: '/srh/public/coursescategoria/delete/' + id,  // Verifica que esta ruta sea correcta
        type: 'DELETE',
        data: {
            _token: token  // Incluye el token CSRF
        },
        success: function(response) {
            window.location.href = '/srh/public/coursescategoria/list';  // Redirigir a la lista de cursos
        },
