                ...
                <div class="card custom-card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="card-title">Nombre Tipo de Acción</h4>
                                @if($letterAdminMatch)
                                    <p class="card-description">
                                        ¿Deseas agregar un registro? 
                                        <a href="{{ route('coursestipoac.create') }}" class="text-danger" style="margin-left: 10px;">
                        ...
                        <x-template-table.template-table>
                            <thead>
                                <tr>
                                    <th>Id_Tipo_Acción</th>
                                    <th>Descripción</th>
                                    <th>Estatus</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($coursestipoac  as $course)
                                    <tr>
                                        <td>{{ $course->id_tipo_accion}}</td>
