                ...
                <div class="card custom-card">
                    <div class="card-body">
                            ...
                            <div>
                                ...
                                @if($letterAdminMatch)
                                    <p class="card-description">
                                        ...
                                        <a href="{{ route('coursescoordinacion.create') }}" class="text-danger" style="margin-left: 10px;">
                        ...
                        <x-template-table.template-table>
                            <thead>
                                <tr>
                                    <th>Id_Coordinacion</th>
                                    <th>Descripción</th>
                                    <th>Estatus</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($coursescoordinacion as $course)
                                    <tr>
                                        <td>{{ $course->id_coordinacion }}</td>
