                ...
                <div class="card custom-card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="card-title">Nombre Programa</h4>
                                @if($letterAdminMatch)
                                    <p class="card-description">
                                        ¿Deseas agregar un registro? 
                                        <a href="{{ route('coursesprograma.create') }}" class="text-danger" style="margin-left: 10px;">
                        ...
                        <x-template-table.template-table>
                            ...
                            <tbody>
                                @foreach($coursesprograma  as $course)
                                    <tr>
                                        <td>{{ $course->id_programa_institucional}}</td>
