        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <x-template-tittle.tittle-header tittle="Catalogo de cursos" caption="Estatuto Organico" />
                    </div>
                </div>
            </div>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <x-template-tittle.tittle-caption
                            tittle="{{ isset($course->id_estatuto_organico) ? 'Modificar' : 'Agregar ' }} Curso Estatuto Organico"
                            route="{{ route('coursesestatuto.list') }}" />
                        
                        <br>
                        <form action="{{ route('coursesestatuto.edit', $course->id_estatuto_organico) }}" method="POST">
                            @csrf
                            ...
                            <x-template-button.button-form-footer routeBack="{{ route('coursesestatuto.list') }}" />
                        </form>
                    </div>
                </div>
            </div>
